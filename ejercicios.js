...
module.exports = {
    compareTenAndNine();  // No se puede exportar una función que no devuelve nada
    compareZeroAndZero();   // No se puede exportar una función que no devuelve nada
    compareSeven();   // No se puede exportar una función que no devuelve nada
